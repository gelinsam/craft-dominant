...
export default function CampaignIntelligence() {
  ...
  return <section aria-label="Campaign intelligence" className="rounded-xl border border-indigo-200 bg-indigo-50/40 p-4 sm:p-5">
    ...
    <p className="mt-2 text-sm text-slate-600">Built from {report.mailchimp} Mailchimp reports and {report.eventbrite} recovered Eventbrite campaigns. Comparison recalculated {report.as_of}; Eventbrite history remains partial. These are working ideas, not proven sales lifts.</p>
